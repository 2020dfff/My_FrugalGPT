...
supported_LLM = FrugalGPT.getservicename(configpath='config/serviceinfo_abt-buy.json')
...
frugalgpt_df.to_csv(f"summary/summary_{dataname}_e8_frugalgpt_2025_0407.csv")
